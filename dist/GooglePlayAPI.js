...
exports.GooglePlayAPI = void 0;
const tslib_1 = require("tslib");
const axios_1 = tslib_1.__importDefault(require("axios"));
const qs_1 = tslib_1.__importDefault(require("qs"));
const ini_1 = tslib_1.__importDefault(require("ini"));
const lodash_1 = require("lodash");
const protoBuf = tslib_1.__importStar(require("./ProtoBuf"));
...
class GooglePlayAPI {
    ...
    constructor(email, gsfID) {
        ...
        Object.defineProperty(this, "_gsfID", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "_apiEndpoint", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "_authPath", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "_playApiPath", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        Object.defineProperty(this, "_googlePlayServiceVersion", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "_sdkVersion", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "_callerSig", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "_callerPkg", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        Object.defineProperty(this, "_languageCode", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "_enabledExperiments", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "_unsupportedExperiments", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "_axiosConfigForGooglePlay", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "_axiosConfigForGooglePlay_Protobuf", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "_axiosConfig", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
    ...
    async getGoogleToken(oauth2Token, saveTokenFilePath = 'token.txt') {
        if (oauth2Token.startsWith('oauth2_4/')) {
            const pathIsExists = await (0, FileControl_1.isExists)(saveTokenFilePath);
            if (pathIsExists) {
                return await (0, FileControl_1.readToken)(saveTokenFilePath);
            }
            try {
                const axiosData = await axios_1.default.post(`${this._apiEndpoint}${this._authPath}`, qs_1.default.stringify({
                ...
                const parse = ini_1.default.parse(axiosData.data);
                const token = parse.Token;
                await (0, FileControl_1.writeToken)(saveTokenFilePath, token);
                return token;
            }
            catch (e) {
    ...
    async appDetails(packageName) {
        try {
            ...
            const axiosData = await axios_1.default.get(apiUrl, this._axiosConfigForGooglePlay);
    ...
    async bulkDetails(...packages) {
        try {
            ...
            const axiosData = await axios_1.default.post(`${this._apiEndpoint}${this._playApiPath}/bulkDetails`, data, this._axiosConfigForGooglePlay_Protobuf);
            return (0, lodash_1.map)(protoBuf.decode(axiosData.data).payload?.bulkDetailsResponse?.entry, 'item');
        }
        catch (e) {
    ...
    async purchase(packageName, offerType, versionCode) {
        try {
            const axiosData = await axios_1.default.post(`${this._apiEndpoint}${this._playApiPath}/purchase`, qs_1.default.stringify({
    ...
    async downloadApk(packageName, outputPath, versionCode = null, outputFileName = null) {
        try {
            ...
            if (!(0, FileControl_1.isExtMatch)(fileName, 'apk')) {
                fileName += '.apk';
            }
            const downloadApkUrl = await this.downloadApkUrl(packageName, versionCode);
            if (downloadApkUrl)
                return await (0, FileControl_1.downloadFile)(downloadApkUrl, outputPath, fileName);
        }
        catch (e) {
    ...
    async downloadSplitApksNameAndUrl(packageName, versionCode = null) {
        try {
            ...
            return (0, lodash_1.map)(splitDeliveryData, data => {
                return {
                    name: data.name,
    ...
    async downloadSplitApks(packageName, outputPath, versionCode = null, outputFileNamePrefixe = null) {
        try {
            ...
            for (const data of downloadSplitApksNameAndUrl) {
                if (data.downloadUrl)
                    return await (0, FileControl_1.downloadFile)(data.downloadUrl, outputPath, `${fileName}-${data.name}.apk`);
            }
        }
        catch (e) {
    ...
    async downloadAdditionalFileUrls(packageName, versionCode = null) {
        try {
            ...
            return (0, lodash_1.map)(additionalFileInfo, 'downloadUrl');
        }
        catch (e) {
        ...
        try {
            ...
            if (downloadAdditionalFileUrls) {
                for (const [key, url] of downloadAdditionalFileUrls.entries()) {
                    await (0, FileControl_1.downloadFile)(url, outputPath, `${fileName}_${(key + 1)}`);
                }
                return true;
            }
        }
...
exports.GooglePlayAPI = GooglePlayAPI;
